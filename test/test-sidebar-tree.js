...
{
  const tree = buildSidebarTree(path.join(fixtureDir, 'root.md'));
...
{
  const tree = buildSidebarTree(path.join(fixtureDir, 'isolated.md'));
  assert.ok(tree, 'Should return tree');
...
{
  const tree = buildSidebarTree(path.join(fixtureDir, 'self-ref.md'));
  assert.ok(tree, 'Should return tree');
...
{
  const tree = buildSidebarTree(path.join(fixtureDir, 'external-only.md'));
  assert.ok(tree, 'Should return tree');
...
{
  const tree = buildSidebarTree(path.join(fixtureDir, 'code-links.md'));
  assert.ok(tree, 'Should return tree');
...
{
  const tree = buildSidebarTree(path.join(fixtureDir, 'has-external.md'));
  assert.ok(tree, 'Should return tree');
