...
(async () => {
  ...
  {
    const tree = await buildLinkTree(path.join(fixtureDir, 'root.md'));
  ...
  {
    const tree = await buildLinkTree(path.join(fixtureDir, 'nonexistent.md'));
  ...
  {
    const tree = await buildLinkTree(path.join(fixtureDir, 'self-ref.md'));
