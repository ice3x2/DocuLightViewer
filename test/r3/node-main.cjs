...
let fixture;
let selectedCase;
run(['harness-self', 's04', 's05', 's06', 's07', 's08', 's09', 's10', 's11', 's12', 's13', 's14', 's15', 's16', 's17', 's18', 's19', 's20'].map(name => ({ name, async run(context) { return selectedCase.run(context); } })), name, {
